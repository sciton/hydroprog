...
gpuErrchk(cudaHostGetDevicePointer( &devx, x, 0 ));
gpuErrchk(cudaHostGetDevicePointer( &devy, y, 0 ));
gpuErrchk(cudaHostGetDevicePointer( &devVx, Vx, 0 ));
gpuErrchk(cudaHostGetDevicePointer( &devVy, Vy, 0 ));
gpuErrchk(cudaHostGetDevicePointer( &devax, ax, 0 ));
gpuErrchk(cudaHostGetDevicePointer( &devay, ay, 0 ));
